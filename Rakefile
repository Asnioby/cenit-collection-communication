...
Jeweler::Tasks.new do |gem|
  ...
  gem.name = 'cenit-collection-communication'
  gem.license = "MIT"
  gem.summary = 'Shared Collection cenit-collection-communication to be use in Cenit'
  gem.description = 'Shared Collection cenit-collection-communication to be use in Cenit'
  gem.author = 'Asnioby Hdez'
  gem.email = 'asnioby@gmail.com'
  gem.homepage = 'https://github.com/asnioby/cenit-collection-communication'
...
task :create_repo do
  options = {
    project_name: 'cenit-collection-communication', 
    user_name: 'Asnioby Hdez', 
    user_email: 'asnioby@gmail.com',
    github_username: 'asnioby',
    summary: 'Shared Collection cenit-collection-communication to be use in Cenit',
    description: 'Shared Collection cenit-collection-communication to be use in Cenit',
    homepage: 'https://github.com/asnioby/cenit-collection-communication',
...
require File.expand_path(File.join(*%w[ lib cenit collection communication]), File.dirname(__FILE__))
task :push do
...
Rake::RDocTask.new do |rdoc|
  ...
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title = "cenit-collection-communication #{version}"
